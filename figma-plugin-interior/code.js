...
const TOURS = [
  { id:'wild-atlantic',    name:'Wild Atlantic Way',           price:89,  label:'per person', dur:'8 Hours',  grp:'Up to 12', type:'Full Day',   eyebrow:'COASTAL ADVENTURE',          accent:{ r:0.07,g:0.30,b:0.17 }, highlights:["Slieve League Cliffs","Malin Head","Pub lunch included"],     itinerary:[{t:"8:00am",h:"Departure",d:"Pick-up from Derry / Sligo."},{t:"9:30am",h:"Malin Head",d:"Ireland's northernmost point."},{t:"11:00am",h:"Slieve League",d:"Walk the cliff paths."},{t:"1:00pm",h:"Lunch",d:"Traditional pub lunch included."},{t:"6:00pm",h:"Return",d:"Drop-off at pick-up point."}], inc:["Expert guide","Coach","Pub lunch","Entry fees"], exc:["Insurance","Gratuities"] },
  { id:'giants-causeway',  name:"Giant's Causeway & Antrim",   price:105, label:'per person', dur:'Full Day', grp:'Up to 10', type:'Premium',    eyebrow:'UNESCO WORLD HERITAGE',      accent:{ r:0.13,g:0.27,b:0.40 }, highlights:["Giant's Causeway","Carrick-a-Rede rope bridge","Dark Hedges"], itinerary:[{t:"7:30am",h:"Departure",d:"Pick-up from Derry."},{t:"9:00am",h:"Dark Hedges",d:"Game of Thrones location."},{t:"10:00am",h:"Giant's Causeway",d:"UNESCO site visit."},{t:"2:00pm",h:"Rope Bridge",d:"Cross the famous bridge."},{t:"5:30pm",h:"Return",d:"Coastal drive back."}], inc:["Expert guide","Coach","Causeway entry","Bridge entry"], exc:["Lunch","Insurance"] },
...
function makeContent(t) {
  ...
  RI(hc, 'Mon–Sat 8am–7pm', 24, 44, 13, C.mid);
...
function makeFooter() {
  ...
  RI(f, "Ireland's Premier Tour Operator since 2012.", P, 76, 13, C.footFg, 300, null, 22);
